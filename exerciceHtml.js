...
{   
    ...
    questions = [ 'Przetłumacz zdania', 'Lubię morze.', 'Wolę kuchnię francuską.', 'Nie znoszę hałasu.', 'Uwielbiam spać.', 'Nie lubię alkoholu.', 'Uwielbiam podróżować.', 'Nie znoszę tańczyć.', 'Lubię kwiaty.', 'Nie lubię piwa.', 'Wolę wino.' ];
    answers = [ 'Użyj czasowników w nawiasach', "J'aime la mer", 'Je préfère la cuisine française', 'Je déteste le bruit', "J'adore dormir", "Je n'aime pas l'alcool", "J'adore voyager", 'Je déteste danser', "J'aime les fleurs", "Je n'aime pas la bière", 'Je préfère le vin' ];
    hints = [ 'Verbes', 'aimer', 'préférer', 'détester', 'adorer', 'ne pas aimer', 'adorer', 'détester', 'aimer', 'ne pas aimer', 'préférer' ];
    ...
    for(var i = 1; i < questions.length; i++)
    {
        ...
        var fullStopSpan = document.createElement("span");
        fullStopSpan.innerText = " .";
        paragraph.appendChild(fullStopSpan);
        myForm.appendChild(paragraph); 
    }
    ...
    document.getElementById("button").onclick = function()
    {
        ...
        for(var i = 1; i < questions.length; i++)
        {
            ...
            {            
                ...
                document.getElementById("par"+i).appendChild(fullStopSpan).appendChild(myparagraph);
            }else
            {
                var fullStopSpan = document.createElement("span");
                fullStopSpan.innerText = " .";
